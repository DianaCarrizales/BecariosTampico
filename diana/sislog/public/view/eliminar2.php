            ...
            <div class="box">
				...
				<td>
						...
						<?php
						  ...
						  $id=$_GET['id'];
						  $result = mysqli_query($conexion,"SELECT id FROM wish WHERE id='$id'");
						  $row = mysqli_fetch_assoc($result);
						?>
						<form  method="POST" action="delete2.php" align=center>
                        <div class="row">
							<div class="form-group col-lg-4">
                                <label>Identificador de Pensamiento</label>
							...
							<div class="form-group col-lg-3">
								<a href="verRegistrosPensamientos.php"><input align="right" type="button" value="Volver a los Registros"></a>
                            </div>
							</center>
                        </div>
                    </form>
