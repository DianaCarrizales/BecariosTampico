<?php
	...
	$sentencia=("UPDATE alumnos set Nombre='$_POST[Nombre]',Apellido='$_POST[Apellido]',Telefono='$_POST[Telefono]',Direccion='$_POST[Direccion]',Email='$_POST[Email]',FechaNacimiento='$_POST[FechaNacimiento]',MunicipioId='$_POST[MunicipioId]',ProgramaId='$_POST[ProgramaId]' WHERE Matricula='$_POST[Matricula]'");
            ...
            <div class="box">
                <div class="col-lg-12">
                    ...
                    <h2 class="intro-text text-center">Felicidades.
                        <strong> Su registro ha sido actualizado correctamente.</strong>
                    </h2>
                    <center><hr></center>
